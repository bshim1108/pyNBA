...
class LineupOptimizer:
    def __init__(self, settings: Type[BaseSettings], solver: Type[Solver] = PuLPSolver):
        ...
        self._standard_deviation = 0.25
        self._max_deviation = 3
    ...
    def set_deviation(self, standard_deviation: float):
        """
        Set standard deviation for randomness mode
        """
        self._standard_deviation = standard_deviation

    def get_standard_deviation(self) -> Tuple[float, float]:
        return self._standard_deviation

    def set_max_deviation(self, max_deivation: float):
        """
        Set max deviation for randomness mode
        """
        self._max_deviation = max_deivation

    def get_max_deviation(self) -> Tuple[float, float]:
