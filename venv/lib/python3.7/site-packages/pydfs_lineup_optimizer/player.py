...
class Player:
    def __init__(self,
        ...
        self._standard_deviation = None  # type: Optional[float]
    ...
    def standard_deviation(self, standard_deviation: Optional[float]):
        self._standard_deviation = process_percents(standard_deviation)
