...
class MTPSModel(object):
    ...
    def create_features(self, odds_data, sp_threshold=60):
        ...
        data = self.feature_creation.expanding_weighted_mean(
            df=data, group_col_names=['SEASON', 'TEAM', 'PLAYERID'], col_name='ATPS', new_col_name='AVG_ATPS',
        ...
        data = self.feature_creation.expanding_weighted_mean(
            df=data, group_col_names=['SEASON', 'TEAM', 'PLAYERID'], col_name='FG3%', new_col_name='AVG_FG3%',
            weight_col_name='FG3A'
        )
        data = self.feature_creation.rolling_weighted_mean(
        ...
        data = self.feature_creation.expanding_weighted_mean(
            df=data, group_col_names=['SEASON', 'START_LINEUP', 'PLAYERID'], col_name='ATPS',
            weight_col_name='SECONDSPLAYED', new_col_name='AVG_ATPS_STARTERS'
        )
        data = self.feature_creation.expanding_weighted_mean(
